...
<a href="{{ route('teacher.certchain.events.create') }}" class="btn-primary text-sm">+ Create Event</a>
@endsection
...
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <div class="card p-5 flex flex-col">
        ...
        <div class="mt-auto pt-3 border-t border-gray-100 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('teacher.certchain.certificates.create') }}?event_id={{ $event->id }}" class="text-xs text-blue-600 hover:underline">Issue</a>
                <a href="{{ route('teacher.certchain.events.edit', $event) }}" class="text-xs text-gray-500 hover:underline">Edit</a>
    ...
    <div class="md:col-span-3 card p-12 text-center">
        ...
        <a href="{{ route('teacher.certchain.events.create') }}" class="btn-primary inline-block text-sm">+ Create Event</a>
    </div>
    @endforelse
</div>
